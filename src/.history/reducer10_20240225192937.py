...
hadoop jar /opt/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.2.1.jar -mapper /scripts/mapper1.py -reducer "/scripts/reducer1.py" -input /access_log -output /outputone